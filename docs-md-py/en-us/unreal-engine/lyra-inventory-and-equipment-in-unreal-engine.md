...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/lyra-inventory-and-equipment-in-unreal-engine
...
**Equipment** is an item that can be equipped to a player, potentially changing their gameplay visuals, UI, or granting passive or active [Abilities](https://dev.epicgames.com/documentation/en-us/unreal-engine/abilities-in-lyra-in-unreal-engine). Typically an equipped item is instantiated based on an inventory item.
