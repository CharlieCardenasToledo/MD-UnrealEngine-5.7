...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/live-link-hub-quick-start-in-unreal-engine
...
![Live Link plugins](https://dev.epicgames.com/community/api/documentation/image/c7275950-d773-48b3-9181-822cf381a75c)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "Live Link - this plugin is on by default in blank projects. You may have disabled it previously. If so, enable it now.",
      "settings": {
        "is_hidden": false
      }
    }
...
![Live Link Hub in the Tools menu](https://dev.epicgames.com/community/api/documentation/image/d6af2b64-0d1d-42c3-9fb6-ccd66329ead8)
...
![An Unreal Editor session in Live Link Hub](https://dev.epicgames.com/community/api/documentation/image/f29e5921-e70e-4712-8097-3c977abba1cf)

In UE, the message bar will show a green Live Link Connected banner:

![Live Link Connected banner](https://dev.epicgames.com/community/api/documentation/image/e28c6c8d-d4f1-4c38-9c1c-35b79d8b4077)

If there is an error, the message bar will show a warning message:

![Live Link Hub Error warning message](https://dev.epicgames.com/community/api/documentation/image/b76cf9c6-9814-4ae9-bc7b-3165a631f8ec)

Open the Live Link panel in UE to check if there is a source listed, labeled Live Link Hub. It should appear as follows:

![Live Link Hub source in the Live Link panel](https://dev.epicgames.com/community/api/documentation/image/de29f6ed-50c1-4ec2-91df-1081469311c2)
...
![Add a source](https://dev.epicgames.com/community/api/documentation/image/cd4a0e3b-6c45-465b-b442-f4620f84b9f4)

Data will be sent to all the connected clients. Your source’s subjects will be listed on the central **Subjects** panel:

![Your source's subjects](https://dev.epicgames.com/community/api/documentation/image/8e8632eb-bba7-4d79-ad95-e56e67d3bb1d)
...
![Live Link subjects listed in Unreal Engine](https://dev.epicgames.com/community/api/documentation/image/7b5ff639-a16c-4765-95f3-514ea47d4c38)
...
```json
{
  ...
  "title": "",
  "code_preview": "[your install directory]\\Engine\\Binaries\\LiveLinkHub.exe -EnablePlugins=&quot;LiveLinkFreeD,LiveLinkPrestonMDR,LiveLinkMasterLockit,LiveLinkVRPN&quot;",
  "lines_of_code": 1,
  "id": 51819,
  "url_signature": "eyJzbmlwcGV0X2lkIjo1MTgxOSwidXJsX2V4cGlyZXNfYXQiOiIyMDI2LTAzLTA5VDE4OjI1OjMxKzAwOjAwIn0=--89cd990cfb0e6752e0da6b5bd63a1934f9a28464fbab9f46adc71cda46f83426",
  "settings": {
    "is_hidden": false
  }
}
