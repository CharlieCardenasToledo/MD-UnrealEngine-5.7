...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/migrate-to-iris-in-unreal-engine
...
| [Priority](https://dev.epicgames.com/documentation/404) | ✓ | Iris Prioritization |
...
| [Relevancy](https://dev.epicgames.com/documentation/404) | ✓ | Iris Filtering |
| [Remote Procedure Calls](https://dev.epicgames.com/documentation/404) |  |  |
| [Subobject Replication](https://dev.epicgames.com/documentation/en-us/unreal-engine/replicating-uobjects-in-unreal-engine) | ✓ | [Iris Subobject Replication](https://dev.epicgames.com/documentation/en-us/unreal-engine/migrate-to-iris-in-unreal-engine#subobjectreplication) |
...
Replicated properties work as they do in the generic replication system. For more information about how replicated properties work in UE, see the [Replicate Actor Properties](https://dev.epicgames.com/documentation/en-us/unreal-engine/replicate-actor-properties-in-unreal-engine) documentation.

## Remote Procedure Calls

Remote Procedure Call (RPC) declaration and execution in Iris works as it does in the generic replication system and replication graph. For more information about how RPC and replicated property updates are executed on receiving machines, see the [Replication Execution Order](https://dev.epicgames.com/documentation/404) documentation.
...
For more information about replicated subobjects, see the [Replicated Subobjects](https://dev.epicgames.com/documentation/en-us/unreal-engine/replicating-uobjects-in-unreal-engine) documentation.
