...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-google-drive-for-turnkey-for-unreal-engine
...
2. Add the relevant `<FileSource>` information for the SDKs you have available. For example, the following would be a valid `<FileSource>` for `TurnkeyManifest_Win64.xml`:
   ...
   Refer to [Setting Up Turnkey for Your Organization](https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-turnkey-for-your-organization-in-unreal-engine) for more information on how to format manifests.
