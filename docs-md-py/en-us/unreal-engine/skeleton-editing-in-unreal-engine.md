...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/skeleton-editing-in-unreal-engine
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/c11ca7c6-032e-42c6-95bd-2e18078c7c9b)
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/fe66306b-4efe-4c6d-af3f-762e5afde932)

When creating a new Skeleton asset, a single `root` bone will be created at the origin point of the Static Mesh.

![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/39b6b10f-fe0a-4e5f-8f4b-efbf707787a4)
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/30087292-5f19-4fce-8f06-949bee735a4e)
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/47549ab4-9bf7-4d58-bcd5-ad2490db24ee)

Using the **Edit Skeleton** tool will let you place bones within the mesh in the viewport.

[Video: V_ySHcNa](https://dev.epicgames.com/community/api/cms/videos/V_ySHcNa/embed.html)
...
[Video: V_ZLyet5](https://dev.epicgames.com/community/api/cms/videos/V_ZLyet5/embed.html)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "Use the <strong>Axis Length</strong> and the <strong>Axis Thickness</strong> to visualize what direction the new bones are pointing.",
      "settings": {
        "is_hidden": false
      }
    },
...
[Video: V_JyfwbV](https://dev.epicgames.com/community/api/cms/videos/V_JyfwbV/embed.html)

### Renaming Bones

Bones can be **Renamed** (**F2**) by right-clicking on the bone and selecting the **Rename Bone** option from the context menu.

![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/642ea0b2-67b1-49db-81bc-9208d52d5467)
...
[Video: V_LUmsSA](https://dev.epicgames.com/community/api/cms/videos/V_LUmsSA/embed.html)
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/38ca4791-28b7-453f-9703-668dda7fb533)
...
[Video: V_G9wQRV](https://dev.epicgames.com/community/api/cms/videos/V_G9wQRV/embed.html)
...
[Video: V_MvJlT6](https://dev.epicgames.com/community/api/cms/videos/V_MvJlT6/embed.html)
...
```json
{
  ...
  "blocks": [
    ...
    {
      "type": "paragraph",
      "content": "For example, if a vertex on the elbow has a value of <code>0.7</code> on the forearm bone, then the remaining <code>0.3</code> weight<strong> </strong>will<em> </em>be assigned to one or more other bones. In this case, it likely belongs to the upper arm.",
      "settings": {
        "is_hidden": false
      }
    },
    {
      "type": "paragraph",
      "content": "When you edit a vertex weight, Unreal will automatically normalize the other weights to ensure that the total value is always equal to 1, which may result in Unreal Engine automatically adjusting values of Skin Weights.",
      "settings": {
        "is_hidden": false
      }
    },
    {
      "type": "paragraph",
      "content": "In the case that the vertex only has 1 influence, only 1 bone with a weight greater than zero, you cannot meaningfully modify the weight on that bone. Setting the weight to anything other than <code>1.0</code> will trigger the normalization procedure which will set the value back to <code>1.0</code>, regardless of the value you assign. Once a vertex has a non-zero weight assigned to multiple<em> </em>bones, the normalization procedure will dump extra weight onto the other influences as needed to achieve the weight set by the user.",
      "settings": {
        "is_hidden": false
      }
    },
    {
      "type": "paragraph",
      "content": "Consider the previous example with a vertex with a weight of 0.7 on the forearm and 0.3 on the upper arm. If the user attempts to <em>remove </em>weight on the forearm, perhaps by setting it to a lower value of 0.6, then the normalization procedure will automatically change the upper arm value from 0.3 to 0.4, so as to maintain a total value of 1.",
      "settings": {
        "is_hidden": false
      }
    },
    {
      "type": "paragraph",
      "content": "It is best to only explicitly add<em> </em>vertex weights, allowing the normalization procedure to remove<em> </em>weight as needed to achieve the desired value.",
      "settings": {
        "is_hidden": false
      }
    },
    {
      "type": "paragraph",
      "content": "If you want a bone to have less<em> </em>influence, it is better to add additional weight to a different bone. This allows you to be explicit about where the influence belongs, rather than relying on normalization to split it evenly among the other influences.",
      "settings": {
        "is_hidden": false
      }
    }
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/b9ca36ed-f81e-448e-bee2-594d712a2c3b)
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/411cfc58-15f1-41b7-81a2-89a8630b763c)
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/89c1aeba-4d68-4497-baed-4a1e30d1f6fb)
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/0c7c1c45-4768-44d5-b281-c04b4eb9afc6)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "The <strong>B </strong>hotkey<em> </em>can be used to visually edit the <strong>Brush Size</strong> and the <strong>Brush Strength.</strong>",
      "settings": {
        "is_hidden": false
      }
    },
    {
      "type": "paragraph",
      "content": "Hold down B and <strong>drag left & right</strong> to edit the <em>Radius </em>of the brush.",
      "settings": {
        "is_hidden": false
      }
    },
    {
      ...
      "image": {
        "id": 24509411,
        "file_name": "image_17.gif",
        "file_size": 15626942,
        "content_type": "image/gif",
        "created_at": "2025-04-15T19:34:38.834+00:00",
        "height": 709,
        "width": 851,
        "storage_key": "671f1870-3b6d-4845-8c12-90d4191be50c",
    ...
    {
      "type": "paragraph",
      "content": "Hold down B and <strong>drag up & down</strong> to edit the <em>Strength </em>of the brush.",
      "settings": {
        "is_hidden": false
      }
    },
...
[Video: V_sSNrmC](https://dev.epicgames.com/community/api/cms/videos/V_sSNrmC/embed.html)
...
[Video: V_OMoEfQ](https://dev.epicgames.com/community/api/cms/videos/V_OMoEfQ/embed.html)
...
| **Flood Weights** | Flood the selected weights using the **Brush Operations**. You can flood weights by selecting vertices and a bones and using the **Add** operation. [Video: V_pwBJrV](https://dev.epicgames.com/community/api/cms/videos/V_pwBJrV/embed.html) |
...
[Video: V_uKnlhW](https://dev.epicgames.com/community/api/cms/videos/V_uKnlhW/embed.html)
...
[Video: V_SzBngO](https://dev.epicgames.com/community/api/cms/videos/V_SzBngO/embed.html)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "When using the Vertices mode, if no vertices are selected the operations will run on all vertices affected by the selected bone. This can be useful for mirroring weights for the entire Left side of a character to the Right side",
      "settings": {
        "is_hidden": false
      }
    }
...
![ImageAltText](https://dev.epicgames.com/community/api/documentation/image/996aa4f6-072d-4a0d-8277-89d422ce52bd)
...
[Video: V_sMRbfj](https://dev.epicgames.com/community/api/cms/videos/V_sMRbfj/embed.html)
...
```json
{
  ...
  "title": "",
  "code_preview": "mesh_path = &quot;/Game/Characters/Mannequins/Meshes/SKM_Quinn_Simple&quot;\n\nasset_editor = unreal.EditorAssetLibrary()\n\nskel_mesh = asset_editor.load_asset(mesh_path)",
  "lines_of_code": 5,
  "id": 38907,
  "url_signature": "eyJzbmlwcGV0X2lkIjozODkwNywidXJsX2V4cGlyZXNfYXQiOiIyMDI2LTAzLTA5VDE4OjI1OjE4KzAwOjAwIn0=--95d328cd186a65327e8a0ca0c3c47eff3ec54f512b09ae6e10e8882a021e1b74",
  "settings": {
    "is_hidden": false
  }
}
...
```json
{
  ...
  "snippet_type": "cpp_programming",
  "title": "",
  "code_preview": "# load the weight modifier\n\nweight_modifier = unreal.SkinWeightModifier()\n\n# load the skeleton modifier\n\nskeleton_modifier = unreal.SkeletonModifier()",
  "lines_of_code": 7,
  "id": 38908,
  "url_signature": "eyJzbmlwcGV0X2lkIjozODkwOCwidXJsX2V4cGlyZXNfYXQiOiIyMDI2LTAzLTA5VDE4OjI1OjE4KzAwOjAwIn0=--e081bd823cec4be0721b6da1b040b168e2f66287bc9f02ee87a5f47940d4e642",
  "settings": {
    "is_hidden": false
  }
}
...
```json
{
  ...
  "snippet_type": "cpp_programming",
  "title": "",
  "code_preview": "# Create two bones, a and b\n\nskeleton_modifier.set_skeletal_mesh(skel_mesh)\n\nskeleton_modifier.add_bones([&quot;a&quot;, &quot;b&quot;],[&quot;root&quot;, &quot;root&quot;], [unreal.Transform(), unreal.Transform()])",
  "lines_of_code": 5,
  "id": 38909,
  "url_signature": "eyJzbmlwcGV0X2lkIjozODkwOSwidXJsX2V4cGlyZXNfYXQiOiIyMDI2LTAzLTA5VDE4OjI1OjE4KzAwOjAwIn0=--a5a26675809f7c378f9fec228db60baae53ca97a7942f2a6b096fc08d81a9e5c",
  "settings": {
    "is_hidden": false
  }
}
...
```json
{
  ...
  "snippet_type": "cpp_programming",
  "title": "",
  "code_preview": "# Parent bone b to bone a\n\nskeleton_modifier.parent_bone(&quot;b&quot;, &quot;a&quot;)",
  "lines_of_code": 3,
  "id": 38910,
  "url_signature": "eyJzbmlwcGV0X2lkIjozODkxMCwidXJsX2V4cGlyZXNfYXQiOiIyMDI2LTAzLTA5VDE4OjI1OjE4KzAwOjAwIn0=--84fb0a0fc4beea599ffbd6857ff6686103f95923f34efebd9b062547869b282a",
  "settings": {
    "is_hidden": false
  }
}
...
```json
{
  ...
  "snippet_type": "cpp_programming",
  "title": "",
  "code_preview": "# Commit the changes\n\nskeleton_modifier.commit_skeleton_to_skeletal_mesh()",
  "lines_of_code": 3,
  "id": 38911,
  "url_signature": "eyJzbmlwcGV0X2lkIjozODkxMSwidXJsX2V4cGlyZXNfYXQiOiIyMDI2LTAzLTA5VDE4OjI1OjE4KzAwOjAwIn0=--f3461ec1da0b69e254df1ec15fd676f89b9ead683fc51278c19aa83ecb8ecf75",
  "settings": {
    "is_hidden": false
  }
}
