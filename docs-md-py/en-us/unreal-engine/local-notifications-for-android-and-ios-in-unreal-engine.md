...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/local-notifications-for-android-and-ios-in-unreal-engine
...
1. First, download and compile a source code build of Unreal Engine. You can find instructions on how to download the source code from GitHub on the [UE4 On GitHub](https://www.unrealengine.com/en-US/ue4-on-github) page as well as the [Downloading Unreal Engine Source Code](https://dev.epicgames.com/documentation/404) guide.
