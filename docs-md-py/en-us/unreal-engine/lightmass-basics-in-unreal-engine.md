...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/lightmass-basics-in-unreal-engine
...
These are just the presets, there are a vast number of settings that can be tweaked to get the desired lighting for your game. See the [Lightmass](https://dev.epicgames.com/documentation/en-us/unreal-engine/cpu-lightmass-global-illumination-in-unreal-engine) documentation for more info on how to fine tune **Lightmass** settings.
