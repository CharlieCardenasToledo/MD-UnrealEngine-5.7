...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/lyra-input-settings-in-unreal-engine

> Application Version: 5.7

Lyra's **Input Settings System** was designed to resolve many common issues with input configuration setups experienced in games. It is based on the [Enhanced Input system](https://dev.epicgames.com/documentation/en-us/unreal-engine/enhanced-input-in-unreal-engine).
