...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/live-link-hub-settings
...
| ![Live Link Hub Settings](https://dev.epicgames.com/community/api/documentation/image/fea933d6-0e2a-4167-8261-0c5b10904b69) | ![Plugins Capture Manager](https://dev.epicgames.com/community/api/documentation/image/6dd9cd38-9141-496f-89db-7f70c8bef4b5) |
| --- | --- |
...
2. Ensure E**nable Third Party Encoder** is enabled in the settings. This will cause some additional options to be available. ![Image](https://dev.epicgames.com/community/api/documentation/image/f53d0583-7982-488b-8720-e59280acb31f)
3. Provide the additional settings as needed: **Third Party Encoder**: The full path to the ffmpeg executable. **Custom Video Command Arguments**: To be used when executing the third party encoder with video data. **Custom Audio Command Arguments**: To be used when executing the third party encoder with audio data.
