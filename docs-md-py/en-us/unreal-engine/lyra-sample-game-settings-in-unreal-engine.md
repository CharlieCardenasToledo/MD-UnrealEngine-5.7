...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/lyra-sample-game-settings-in-unreal-engine
...
The DynamicSetter and DynamicGetter require that you can access the data from the LocalPlayer using [Metadata Property Specifiers](https://dev.epicgames.com/documentation/en-us/unreal-engine/metadata-specifiers-in-unreal-engine) (UFUNCTION/UPROPERTY). Using specifiers ensures these conditions on initialization.
