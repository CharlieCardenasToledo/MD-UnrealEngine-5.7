...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/local-fog-volumes-in-unreal-engine
...
```json
{
  ...
  "image_left_id": 26478609,
  "caption_left": "A scene with placed local fog volumes with | atmosphere and height fog.",
  "image_right_id": 26478610,
  "caption_right": "A scene using only atmosphere and height fog.",
  "image_left": {
    "id": 26478609,
    "file_name": "lfv-withfog.png",
    "file_size": 6274363,
    "content_type": "image/png",
    "created_at": "2026-03-04T22:28:42.122+00:00",
    "height": 1190,
    "width": 2518,
    "storage_key": "24e7786b-b513-41c4-beb3-603c42f68206",
    "context": "documentation"
  },
  "image_right": {
    "id": 26478610,
    "file_name": "lfv-withoutfog.png",
    "file_size": 6369424,
    "content_type": "image/png",
    "created_at": "2026-03-04T22:28:42.327+00:00",
    "height": 1190,
    "width": 2518,
    "storage_key": "e500f7ee-0a26-4a2d-a7f2-11ec0eb887e1",
    "context": "documentation"
  },
  "image_left_storage_key": "24e7786b-b513-41c4-beb3-603c42f68206",
  "image_right_storage_key": "e500f7ee-0a26-4a2d-a7f2-11ec0eb887e1",
  "context": "documentation",
  "settings": {
    "is_hidden": false
  }
...
[Video: V_lZWLhe](https://dev.epicgames.com/community/api/cms/videos/V_lZWLhe/embed.html)
...
|   |   |
| --- | --- |
| ![Local fog volume only](https://dev.epicgames.com/community/api/documentation/image/f6654d62-16b6-414a-b7a2-bcfd7a1ec713) | ![Local fog volume with volumetric fog enabled.](https://dev.epicgames.com/community/api/documentation/image/35a9da1c-9fda-45cf-881e-0de526d275de) |
...
![Local Fog Volume Details Panel Settings](https://dev.epicgames.com/community/api/documentation/image/82c52a9d-2861-4b27-83ed-4704dd37f8ab)
...
| Sorting |   |
| **Fog Sort Priority** | The priority can be used as a way to override the sorting by distance. A lower value means the volume is considered further away. For example, it will draw behind volumes with higher priorities. |

The Project Settings contains the following properties for local fog volumes found in the **Engine > Rendering** section:

![Local Fog Volume project settings.](https://dev.epicgames.com/community/api/documentation/image/3c2ef9b0-7c6f-4631-aec7-5a75cb165521)
...
|   |   |   |
| --- | --- | --- |
| ![Albedo Color White](https://dev.epicgames.com/community/api/documentation/image/c37aefeb-3b2b-4d9d-bf00-204d6a485be1) | ![Albedo Color Green](https://dev.epicgames.com/community/api/documentation/image/82f66dac-7de2-469f-9baa-d6eb13cec640) | ![Albedo Color Brown](https://dev.epicgames.com/community/api/documentation/image/46844f80-eaf2-4d1a-b9f8-4689551ba52f) |
...
|   |   |   |
| --- | --- | --- |
| ![No emissive applied](https://dev.epicgames.com/community/api/documentation/image/15b8888c-6e5b-4af0-b9fe-8629cf66ec93) | ![Emissive color green](https://dev.epicgames.com/community/api/documentation/image/1054e87e-ceb9-4cb8-8da3-a77be78f3089) | ![Emissive color red](https://dev.epicgames.com/community/api/documentation/image/d303621e-9725-4939-8f3c-629db80c434e) |
...
```json
{
  ...
  "caption": "Drag the slider to see Local Fog Scattering Distribution changes from low to high starting with 0, 0.25 , 0.5, 0.75, 0.98, and 0.99",
  "images": [
    {
      "image_id": 26478611,
      "storage_key": "19108324-8257-4e9f-95f4-0a0246a1e4ff",
      "context": "documentation",
      "image": {
        "id": 26478611,
        "file_name": "lfv-scatteringdist-1.png",
        "file_size": 2432016,
        "content_type": "image/png",
        "created_at": "2026-03-04T22:28:42.528+00:00",
        "height": 791,
        "width": 1600,
        "storage_key": "19108324-8257-4e9f-95f4-0a0246a1e4ff",
        "context": "documentation"
    ...
    {
      "image_id": 26478612,
      "storage_key": "b7275ea8-3cd0-419a-b36a-c4515d899275",
      "context": "documentation",
      "image": {
        "id": 26478612,
        "file_name": "lfv-scatteringdist-2.png",
        "file_size": 2471633,
        "content_type": "image/png",
        "created_at": "2026-03-04T22:28:42.629+00:00",
        "height": 791,
        "width": 1600,
        "storage_key": "b7275ea8-3cd0-419a-b36a-c4515d899275",
        "context": "documentation"
    ...
    {
      "image_id": 26478613,
      "storage_key": "4baa516f-035d-4291-822f-ec6669e3c9df",
      "context": "documentation",
      "image": {
        "id": 26478613,
        "file_name": "lfv-scatteringdist-3.png",
        "file_size": 2424937,
        "content_type": "image/png",
        "created_at": "2026-03-04T22:28:42.713+00:00",
        "height": 791,
        "width": 1600,
        "storage_key": "4baa516f-035d-4291-822f-ec6669e3c9df",
        "context": "documentation"
    ...
    {
      "image_id": 26478614,
      "storage_key": "e8f94f56-ad79-4dfa-89a9-2be6111f3f9b",
      "context": "documentation",
      "image": {
        "id": 26478614,
        "file_name": "lfv-scatteringdist-4.png",
        "file_size": 2361787,
        "content_type": "image/png",
        "created_at": "2026-03-04T22:28:42.805+00:00",
        "height": 791,
        "width": 1600,
        "storage_key": "e8f94f56-ad79-4dfa-89a9-2be6111f3f9b",
        "context": "documentation"
    ...
    {
      "image_id": 26478615,
      "storage_key": "85ee8d7f-9a56-4653-b386-025534928e01",
      "context": "documentation",
      "image": {
        "id": 26478615,
        "file_name": "lfv-scatteringdist-5.png",
        "file_size": 2388884,
        "content_type": "image/png",
        "created_at": "2026-03-04T22:28:42.950+00:00",
        "height": 791,
        "width": 1600,
        "storage_key": "85ee8d7f-9a56-4653-b386-025534928e01",
        "context": "documentation"
    ...
    {
      "image_id": 26478616,
      "storage_key": "bd1f84db-1129-4623-b90b-3477688b1051",
      "context": "documentation",
      "image": {
        "id": 26478616,
        "file_name": "lfv-scatteringdist-6.png",
        "file_size": 2601697,
        "content_type": "image/png",
        "created_at": "2026-03-04T22:28:43.084+00:00",
        "height": 791,
        "width": 1600,
        "storage_key": "bd1f84db-1129-4623-b90b-3477688b1051",
        "context": "documentation"
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "To have volumetric fog light shafts, volumetric fog must be enabled and the scattering distribution needs to be closer to zero. The default scattering distribution of 0.2 is a good starting point.",
      "settings": {
        "is_hidden": false
      }
    }
...
![Radial Fog and Height Fog Densities](https://dev.epicgames.com/community/api/documentation/image/0ecec9e2-4fc8-4d00-855e-5ae3e343ec21)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "The phase function of a local fog volume controls the uniformity of the light within the volume. Shadows and light functions are ignored because the lighting is evaluated using fast analytical integrals.",
      "settings": {
        "is_hidden": false
      }
    }
...
|   |   |   |
| --- | --- | --- |
| ![Height Fog Falloff: 500](https://dev.epicgames.com/community/api/documentation/image/bd5bd83c-d912-4c35-8532-a249ab0210ee) | ![Height Fog Falloff: 1000](https://dev.epicgames.com/community/api/documentation/image/9f808549-60b1-4a10-b889-6d98470d04ff) | ![Height Fog Falloff: 2500](https://dev.epicgames.com/community/api/documentation/image/654eaa89-05d0-4eca-895a-ef9c274050a4) |
...
|   |   |   |
| --- | --- | --- |
| ![Height Fog Offset: -0.12](https://dev.epicgames.com/community/api/documentation/image/65ab0b9d-26da-4207-ad63-95694a5014ab) | ![Height Fog Offset: 0](https://dev.epicgames.com/community/api/documentation/image/39f5e0c2-cf91-4a23-9f6c-049ba118c164) | ![Height Fog Offset: 0.12](https://dev.epicgames.com/community/api/documentation/image/92c0543b-cb0f-4dc2-ad07-7d4516e37015) |
...
|   |   |
| --- | --- |
| ![Two local fog volumes with different color composited.](https://dev.epicgames.com/community/api/documentation/image/3669dd5a-8cf5-47c9-a642-563ba215cabb) | ![Two local fog volumes with different color composited with volumetric fog enabled.](https://dev.epicgames.com/community/api/documentation/image/437e42dc-3591-430a-9dbe-a06dc6b86617) |
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "Because volumetric fog is voxelized as participating media, and not sorted, it can result in visuals that look different. For example if the scattering distribution (Phase function) is different from that of the volumetric fog’s, the result could look different.",
      "settings": {
        "is_hidden": false
      }
    }
...
|   |   |
| --- | --- |
| ![Two overlapping local fog volumes viewed from ground level.](https://dev.epicgames.com/community/api/documentation/image/a018dd4e-dc5b-451e-859c-f3cf161b805a) | ![two overlapping local fog volumes viewed from above.](https://dev.epicgames.com/community/api/documentation/image/a7eae770-0462-4112-b1a0-5f64b03af5d1) |
...
- Local fog volumes are culled using screen tiles — where the screen is divided into small squares called tiles — making their cost similar to dynamic lights added to the scene since their cost is related to the extent of the space on screen they use. You can visualize the extent of the cost in screen space using the console command `r.LocalFogVolume.TileDebug`. **1** shows the local fog volume count as a color per tile. **2** shows the local fog volume count as a color per tile and the effect of the pixel discard/clipping.
...
![Local fog volume examples with overlapping for debugging purposes.](https://dev.epicgames.com/community/api/documentation/image/608813ad-e2e9-4b97-82e6-c7a9cd81ba25)

Below shows what the tile debug views look like when enabled using the example scene above.

|   |   |
| --- | --- |
| ![Tile Debug View 1](https://dev.epicgames.com/community/api/documentation/image/8c9d3995-0e6c-4d4f-864d-2bf4aa7ab4a5) | ![Tile Debug View 2](https://dev.epicgames.com/community/api/documentation/image/458ebf58-eda8-4c56-842e-b44b83b9b7b5) |
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "The tile debug views do not work when volumetric fog is enabled.",
      "settings": {
        "is_hidden": false
      }
    }
