...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/shader-debugging-workflows-unreal-engine

> Application Version: 5.7

The primary route to debugging shaders is to enable the console variable `r.Shaders.Symbols`. This will trigger the engine to prepare shaders for debugging by platform-specific programs like [RenderDoc](https://dev.epicgames.com/documentation/en-us/unreal-engine/using-renderdoc-with-unreal-engine) and PIX.
