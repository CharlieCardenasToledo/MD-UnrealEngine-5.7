...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/lumen-global-illumination-and-reflections-in-unreal-engine
...
![Lumen in action](https://dev.epicgames.com/community/api/documentation/image/d2ee1c83-f011-4a16-8be5-12668d2aec5b)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/cce0d2ed-dd05-4844-8591-4652784745ee)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "When Lumen is enabled for a project, precomputed static lighting contributions are disabled and all lightmaps are hidden.",
      "settings": {
        "is_hidden": false
      }
    }
...
![Image](https://dev.epicgames.com/community/api/documentation/image/1ed49c26-c648-4618-a99d-28abbd52d351)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/7d6dd1bd-4b2b-4cc5-9ab5-52166bd16e10)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/38b0b3dc-70e6-4892-b773-0318109255a6)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/965cfd59-fc66-4e03-8f8a-e151859f9e3e)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/3e39a956-7c29-4220-be8b-65546b615870)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/de30d0ed-5dba-42a0-bb59-7d03be9a44e4)

### Lumen Reflections

Lumen solves indirect specular, or reflections, for the full range of material roughness values.

![Image](https://dev.epicgames.com/community/api/documentation/image/8a3601ce-80a5-4c1b-8c2e-f696c43bfa2f)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/a23e6ea1-fd4d-48f1-9bec-41420818571d)

Lumen provides glossy reflections on translucency, like the car windows in the example below.

![Image](https://dev.epicgames.com/community/api/documentation/image/bdea08e6-0980-4903-b1b5-4d7a01112bd4)
...
![Mirror reflections using High Quality Translucent Reflectoions for the project.](https://dev.epicgames.com/community/api/documentation/image/06d61fb7-547f-4e4d-8fe4-fd7598ddbb2b)

Lumen Reflections support **Single Layer Water** materials, with reflections forced to mirror.

![Water material using Single Layer Water with Lumen Reflections.](https://dev.epicgames.com/community/api/documentation/image/2e1b2996-5c8a-413f-9c63-32dea73118d9)
...
![Comparison example of two-sided foliage lit by Lumen.](https://dev.epicgames.com/community/api/documentation/image/9516578e-ccf4-41a6-8f3c-85a62fd4dbd0)

![Example scene with tree canopy's lit by Lumen.](https://dev.epicgames.com/community/api/documentation/image/520de0fe-9e43-4835-888a-11d918eacf2a)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/39b8a114-adeb-40dc-9623-88130b62d282)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/adffb08c-4e0a-4a31-8126-f10a14a0b8be)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "Projects that already use Static Lighting will have their lightmaps loaded into memory and on disk until <strong>Force No Precomputed Lighting</strong> is enabled in the <strong>World Settings</strong> of an already loaded Level. You then need to rebuild the lighting and save the Level to remove lightmap data.",
      "settings": {
        "is_hidden": false
      }
    }
...
![Lumen Material Ambient Occlusion](https://dev.epicgames.com/community/api/documentation/image/cea4589a-97da-4e82-859f-ab54bda4a543)

_Left, Lumen GI on a Skeletal Mesh with only Screen Traces (Software Ray Tracing); Right, Material Ambient Occlusion._
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "Material Ambient Occlusion is not visible when using the Buffer Visualization <strong>Ambient Occlusion</strong> view mode.",
      "settings": {
        "is_hidden": false
      }
    }
