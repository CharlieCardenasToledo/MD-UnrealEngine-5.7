...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/mixed-reality-capture-quick-start-for-unreal-engine
...
1. **Video Camera**  
   UE5 only supports a very specific set of video capture devices; see [Supported Video Devices](https://dev.epicgames.com/documentation/en-us/unreal-engine/supported-video-devices-for-mixed-reality-capture-in-unreal-engine) for the current list of the supported devices. Using a device from the list, connect it to your PC for streaming.
2. **Chroma backdrop**  
...
The calibration process is complicated, so we've created a separate [How To Use The Mixed Reality Capture Calibration Tool](https://dev.epicgames.com/documentation/en-us/unreal-engine/how-to-use-the-mixed-reality-capture-calibration-tool-in-unreal-engine) topic that contains detailed instructions on using the calibration tool.
