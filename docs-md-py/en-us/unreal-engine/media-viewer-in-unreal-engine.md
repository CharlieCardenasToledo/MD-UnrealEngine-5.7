...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/media-viewer-in-unreal-engine

> Application Version: 5.7

![Media Viewer in action.](https://dev.epicgames.com/community/api/documentation/image/064cb6e3-8755-40fd-aa5b-3cf7a1c03964)
...
![Media Viewer plugin](https://dev.epicgames.com/community/api/documentation/image/b61b92ee-0fcb-457c-b555-1d7862225fca)
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "D3D12 hardware accelerated video decoding provides the most playback and scrubbing performance for H.264/5 video files. To enable it, you need to set the following cvars:",
      "settings": {
        "is_hidden": false
      }
    },
    {
      ...
      "items": [
        [
          {
            "type": "paragraph",
            "content": "<code class=\"inline-code\">ElectraDecoders.bDoNotUseD3D12Video</code> set to <code class=\"inline-code\">FALSE</code>",
            "settings": {
              "is_hidden": false
            }
          }
        ...
        [
          {
            "type": "paragraph",
            "content": "<code class=\"inline-code\">ElectraDecoders.bDisableD3D12Video</code> set to <code class=\"inline-code\">FALSE</code>",
            "settings": {
              "is_hidden": false
            }
          }
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "Hardware video decode is fragile and disabled by default because of GPU compatibility concerns. It may crash your editor so use caution. Even if you get it working on a particular PC, do not assume it will work on different hardware .",
      "settings": {
        "is_hidden": false
      }
    }
...
![Media Viewer in the Window menu](https://dev.epicgames.com/community/api/documentation/image/1c9706e5-7653-4932-96f4-b9471421c9dc)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/44a4417e-f76e-4f54-aadb-dab4a1c0914d)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/e5ca0556-026a-4ceb-9b02-70117f255a0e)

### Library

The Media Viewer has a Library tab that contains the following categories:

![Image](https://dev.epicgames.com/community/api/documentation/image/eac4aa35-95c5-4ca7-8adc-5a9745652c1c)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/b7179aba-acaf-488e-8ab5-dfeba4a1be7f)
...
- In **side-by-side view** mode, you can view two media assets simultaneously, and compare them using the middle slider. You can pick between two side-by-side configurations: **Vertical**: compares content with a vertical slider in-between. **Horizontal**: compares content with a horizontal slider in-between.
...
![Media Viewer zoom value in the toolbar](https://dev.epicgames.com/community/api/documentation/image/c18d26e3-8028-491f-af9a-fc1e8379c2b6)

In addition, you can view and set the current zoom value in the Toolbar.

![A/B media bank swap, lock, and reset controls](https://dev.epicgames.com/community/api/documentation/image/16997530-5735-4bb2-adaa-8a7ed8bd2ce8)
...
![Media Viewer opacity and compare controls](https://dev.epicgames.com/community/api/documentation/image/3ff188b1-c9ff-4556-b9a9-e9ec3fdb2c17)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/46d31b08-b59e-4254-8ffc-b13d0a069cd3)

You can adjust the settings for the A and B bank media assets separately. You can inspect and set:

- **Material** **Render Target**: You can use this dropdown menu to select the media asset. **Real Time**: Enable this checkbox for real-time updates.
- **Media** **Offset (X, Y, Z)**: This control sets the default position of the media. You can use the Pan controls to change it while you work. **Rotation (X, Y, Z)** **Scale (X, Y, Z)**: This control sets the default zoom level of the media. You can use the Zoom controls to change it while you work. **Tint**: This control applies a color to the overlay.
- **Panel** **Background Color**: Use the color picker to set the value. **Background Texture**: Select a texture asset to use as the background. Optional.

### Context Menu

Right-clicking anywhere in the main Media Viewer UI opens a context menu with some additional options:

![Media Viewer context menu](https://dev.epicgames.com/community/api/documentation/image/4a68965d-42e4-42bb-9a2e-ac610337d901)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/16136bf8-f116-4431-85e3-88a43deaf9c5)

**Playhead controls** resemble Sequencer controls and provide similar functionality:

- Play forward or reverse. Reverse is only available for some codecs only such as Apple Pro Res.
...
```json
{
  ...
  "blocks": [
    {
      "type": "paragraph",
      "content": "Playback and Scrubbing performance are impacted by many factors including:",
      "settings": {
        "is_hidden": false
      }
    },
    {
      ...
      "items": [
        [
          {
            "type": "paragraph",
            "content": "The type of source media.",
            "settings": {
              "is_hidden": false
            }
          },
          {
            ...
            "items": [
              [
                {
                  "type": "paragraph",
                  "content": "For example, Apple Pro Res files or image sequences will scrub better than their H.264/5 counterparts.",
                  "settings": {
                    "is_hidden": false
                  }
                }
        ...
        [
          {
            "type": "paragraph",
            "content": "The choice of Player within the FileMediaSource UAsset.",
            "settings": {
              "is_hidden": false
            }
          },
          {
            ...
            "items": [
              [
                {
                  "type": "paragraph",
                  "content": "For example, Protron Player plays and scrubs faster because it is optimized for local playback. You might get different results with Electra or WMF players.",
                  "settings": {
                    "is_hidden": false
                  }
                }
        ...
        [
          {
            "type": "paragraph",
            "content": "Specific cvars for hardware decode (applies only to H.264/5 codecs).",
            "settings": {
              "is_hidden": false
            }
          },
          {
            ...
            "items": [
              [
                {
                  "type": "paragraph",
                  "content": "<code class=\"inline-code\">ElectraDecoders.bDoNotUseD3D12Video</code> and <code class=\"inline-code\">ElectraDecoders.bDisableD3D12Video</code> set to <code class=\"inline-code\">FALSE</code>.",
                  "settings": {
                    "is_hidden": false
                  }
                }
...
![Image](https://dev.epicgames.com/community/api/documentation/image/11c60874-a196-48d6-b2a6-bb9b0ac22c34)

Here is an example of dragging and dropping an Apple Pro Res .mov file on the Media Viewer.

![Adding a .mov file to the Media Viewer](https://dev.epicgames.com/community/api/documentation/image/b150e500-4d79-4b2f-84a8-63373a748fab)
...
- After you select the Media Texture on the Media Track in Sequencer, it appears in the Media Viewer. Alternatively, you can drag and drop the asset from the Content Browser.

![Image](https://dev.epicgames.com/community/api/documentation/image/abc21eaa-c469-4116-acda-549661938ab2)
...
- Open the video file File Media Source and set **Electra Protron** as the Player. Alternatively, you can set your **Electra Factory project settings** to pick Protron Player.

![Image](https://dev.epicgames.com/community/api/documentation/image/7494a5c7-0341-42f7-aa3b-88d662d4b875)
...
![Image](https://dev.epicgames.com/community/api/documentation/image/c2824e20-aed0-4415-ad11-cc0cf92054ca)
