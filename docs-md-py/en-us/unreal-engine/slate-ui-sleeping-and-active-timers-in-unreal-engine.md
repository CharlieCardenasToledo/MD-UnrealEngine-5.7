...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/slate-ui-sleeping-and-active-timers-in-unreal-engine
...
* **When performing some sort of animation or interpolation that is not controlled by an [FCurveSequence](https://dev.epicgames.com/documentation/en-us/unreal-engine/slate-ui-sleeping-and-active-timers-in-unreal-engine#fcurvesequenceandactivetimers):**
