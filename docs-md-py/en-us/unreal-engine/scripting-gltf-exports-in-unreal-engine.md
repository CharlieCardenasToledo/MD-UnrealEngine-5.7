...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/scripting-gltf-exports-in-unreal-engine
...
* The export options. For more information, see [glTF Export Options Reference](https://dev.epicgames.com/documentation/en-us/unreal-engine/exporting-unreal-engine-content-to-gltf#gltfexportoptionsreference).
...
You can use the Export to GLTF function to export glTF files at runtime. However, neither [Material baking](https://dev.epicgames.com/documentation/en-us/unreal-engine/how-the-gltf-exporter-handles-unreal-engine-content#materialbaking) nor [Material expression matching](https://dev.epicgames.com/documentation/en-us/unreal-engine/how-the-gltf-exporter-handles-unreal-engine-content#materialexpressionmatching) is possible at runtime, so you need to do one of the following to handle most materials:

* **Pre-bake materials:** in the editor, create glTF proxy Materials. The glTF exporter uses the proxy materials for runtime glTF exports. Proxy Materials automatically ship with your application because they are referenced in the User Data for your Unreal Engine Materials. For more information about creating proxy Materials, see [glTF Proxy Materials](https://dev.epicgames.com/documentation/en-us/unreal-engine/gltf-proxy-materials-in-unreal-engine).
