...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/map-check-errors-in-unreal-engine
...
Map check errors and warnings are displayed following performing a build all of a map and can also be performed separately using the *Map Check* option in the [Level Editor Toolbar](https://dev.epicgames.com/documentation/en-us/unreal-engine/level-editor-toolbar-in-unreal-engine)'s Build menu.
