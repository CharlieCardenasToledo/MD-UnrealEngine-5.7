...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/lightmass-portals-in-unreal-engine
...
* Lightmass Portals are most useful when a scene is lit using a [Skylight](https://dev.epicgames.com/documentation/en-us/unreal-engine/sky-lights-in-unreal-engine), HDR image or a Static Mesh that is set to [Use Emissive for Static Lighting](https://dev.epicgames.com/documentation/en-us/unreal-engine/using-the-emissive-material-input-in-unreal-engine#usingemissivematerialstolighttheworld) checked.
