...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/skin-weight-profiles-in-unreal-engine
...
You can preview what the different Skin Weights for a specific SWP look like inside the [Animation Editors](https://dev.epicgames.com/documentation/en-us/unreal-engine/animation-editors-in-unreal-engine) in the Viewport, or during a Play in Editor session.
...
At runtime, you can set up a SWP for a Skinned Mesh component (or any child-class) using the provided ([Blueprint](https://dev.epicgames.com/documentation/en-us/unreal-engine/blueprints-visual-scripting-in-unreal-engine) exposed) API.
