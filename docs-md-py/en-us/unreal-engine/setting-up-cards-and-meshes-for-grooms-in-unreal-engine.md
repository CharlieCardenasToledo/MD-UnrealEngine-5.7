...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-cards-and-meshes-for-grooms-in-unreal-engine

> Application Version: 5.7

Grooms can have multiple levels of details (LODs) and each can use a strand, card, or mesh for their representation. The number of LODs a groom has is set up in the **LOD** panel of the [Groom Asset Editor](https://dev.epicgames.com/documentation/en-us/unreal-engine/groom-asset-editor-user-guide-in-unreal-engine). Card and mesh geometries are managed in their own **Cards** and **Meshes** panels. In each panel, you can add new entries and configure the mesh geometry and its material.
...
The textures in the list are automatically bound and sampled in a material when using the **Hair Attributes** expression. For more information on this material expression and its usage, see [Groom Material](https://dev.epicgames.com/documentation/en-us/unreal-engine/groom-materials-in-unreal-engine).
...
| **Depth** | The depth texture used for the card asset. This texture is optional, but when set, the value is forwarded to the **Hair Attributes** node in the [Material Editor](https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-material-editor-user-guide). |
| **Coverage** | This texture is used for the card asset. This texture is optional, but when set, the value is forwarded to the **Hair Attributes** node in the [Material Editor](https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-material-editor-user-guide). |
| **Tangent** | This texture is used for the card asset. This texture is optional, but when set the value is forwarded to the **Hair Attributes** node in the [Material Editor](https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-material-editor-user-guide). |
...
To learn how to use this plugin and set it up, see [Hair Card Generator](https://dev.epicgames.com/documentation/en-us/unreal-engine/hair-card-generator-for-grooms-in-unreal-engine).
