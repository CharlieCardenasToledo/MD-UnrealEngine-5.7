...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/skeletal-mesh-to-static-mesh-conversion-in-unreal-engine

> Application Version: 5.7

When creating splash-screens, screenshots, or other in-game static versions characters, it can be helpful to non-destructively convert a posed [Skeletal Mesh](https://dev.epicgames.com/documentation/en-us/unreal-engine/skeletal-mesh-assets-in-unreal-engine) assets to [Static Mesh](https://dev.epicgames.com/documentation/en-us/unreal-engine/static-meshes), in order to preserve its position and reduce the render cost of the still objects.
...
To begin posing a Character in Unreal Engine, open the Skeletal Mesh asset in the [Skeletal Mesh Editor](https://dev.epicgames.com/documentation/en-us/unreal-engine/skeletal-mesh-editor-in-unreal-engine).
...
You can also save posed Skeletal Meshes as [Animation Sequences](https://dev.epicgames.com/documentation/en-us/unreal-engine/animation-sequences-in-unreal-engine) and [Pose assets](https://dev.epicgames.com/documentation/en-us/unreal-engine/animation-pose-assets-in-unreal-engine) for other more dynamic use cases using the Create Asset button in the Skeletal Mesh Editor's toolbar.
...
You can also convert groups of game objects to a single Static Mesh during **Play In Editor** (**PIE**), and other simulation modes within the editor, such as recorded gameplay segments using the [Rewind Debugger](https://dev.epicgames.com/documentation/en-us/unreal-engine/animation-rewind-debugger-in-unreal-engine) to save more dynamic gameplay snapshots.
