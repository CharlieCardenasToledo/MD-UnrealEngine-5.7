...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/select-mode-in-unreal-engine
...
When Select Mode is active, after you drag an instance of an asset from the **Place Actors** panel (by default, located in the upper left corner of the main interface), you can immediately transform and edit Actors in the Level. See [Placing Actors](https://dev.epicgames.com/documentation/en-us/unreal-engine/placing-actors-in-unreal-engine) for other methods of placing Actors.
