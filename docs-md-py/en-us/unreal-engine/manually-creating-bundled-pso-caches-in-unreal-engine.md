...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/manually-creating-bundled-pso-caches-in-unreal-engine

> Application Version: 5.7

While the [runtime PSO precaching system](https://dev.epicgames.com/documentation/en-us/unreal-engine/pso-precaching-for-unreal-engine) should be enough to prevent your game from hitching during PSO compilation, there might be cases where you want to bundle a precreated PSO cache with your game.
...
This document does not cover splitting the cache. To learn more about cache splitting, see [Cooking and Chunking](https://dev.epicgames.com/documentation/404).
