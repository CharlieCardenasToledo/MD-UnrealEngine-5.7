...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/media-framework-quick-start-for-unreal-engine
...
This guide includes some setup using [Materials](https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-materials) and [Blueprints](https://dev.epicgames.com/documentation/en-us/unreal-engine/blueprints-visual-scripting-in-unreal-engine) to achieve the effect of a video playing on a TV. Some prior knowledge of these topics is recommended but not required.
...
* Enable the player to [control playback](https://dev.epicgames.com/documentation/en-us/unreal-engine/control-video-playback-with-blueprints-in-unreal-engine) of the TV.
* Use a [Media Playlist](https://dev.epicgames.com/documentation/en-us/unreal-engine/using-media-playlists-in-unreal-engine) as a Media Source and allow the player to "change the channels" for the TV.
