...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/material-function-expressions-in-unreal-engine
...
This node is used with [Material Functions](https://dev.epicgames.com/documentation/en-us/unreal-engine/material-functions-in-unreal-engine).
...
The **MaterialFunctionCall** expression allows you to use an external [Material Function](https://dev.epicgames.com/documentation/en-us/unreal-engine/material-functions-in-unreal-engine) from another material or function. The external function's input and output nodes become inputs and outputs of the function call node. If a MaterialFunction is selected in the **Content Browser** when placing one of these expressions, it will automatically be assigned.
...
| --- | --- |
| Properties |  |
| **Material Function** | Specifies the [Material Function](https://dev.epicgames.com/documentation/en-us/unreal-engine/material-functions-in-unreal-engine) to be used. |
