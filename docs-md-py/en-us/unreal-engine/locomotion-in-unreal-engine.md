...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/locomotion-in-unreal-engine

> Application Version: 5.7

In **Unreal Engine** character **Locomotion** is built on the foundation of [character object](https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-a-character-in-unreal-engine), [movement](https://dev.epicgames.com/documentation/404), and [animation](https://dev.epicgames.com/documentation/en-us/unreal-engine/animation-assets-and-features-in-unreal-engine) playback. This foundation is supported with Locomotion tools that you can use to synchronize character movement behavior with reactive and dynamic animations.
...
You can enable **Pose Warping** to dynamically adjustment a character's animated poses to align with character movement, using [Root Motion](https://dev.epicgames.com/documentation/en-us/unreal-engine/locomotion-in-unreal-engine#root motion). With Pose Warping, you need fewer individual animations to reach the same level of animated-movement coverage as before. This reduces the dependency on animation-dictated gameplay, and allows animation and gameplay tuning to evolve side by side during development.
...
With **Motion Warping**, you can dynamically warp windows of a character's animation to align with [Root Motion](https://dev.epicgames.com/documentation/en-us/unreal-engine/locomotion-in-unreal-engine#root motion) or to align with assigned **Warp Targets**. With this feature, you can rely less on the manual creation and fine tuning of animations to fit specific object interactions, and apply logic to bend base animations to fit pre-established conditions.
