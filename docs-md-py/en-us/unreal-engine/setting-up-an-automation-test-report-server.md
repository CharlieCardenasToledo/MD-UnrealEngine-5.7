...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-an-automation-test-report-server
...
1. Make sure you have installed all the needed [prerequisites](https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-an-automation-test-report-server#prerequisites).
...
4. If you provide a [session name](https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-an-automation-test-report-server#sessions) and move `Index.html` and `index.json` (normally found in the target directory) along with the directory, you can access the results of a specific test session by name.
