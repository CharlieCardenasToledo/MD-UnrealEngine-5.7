...
Which one of these you choose depends on what regions you localize your project for, and these choices can be set in your **Project Settings**. See [Packaging Localization Data](https://dev.epicgames.com/documentation/en-us/unreal-engine/localization-overview-for-unreal-engine#packaginglocalizationdata) for more information.
...
To solve this, use "es" for European Spanish, and "es-419" for Latin American Spanish. Then use the [culture remapping](https://dev.epicgames.com/documentation/en-us/unreal-engine/managing-the-active-culture-at-runtime#cultureremapping) feature of UE to map the Latin American Spanish speaking countries to "es-419".
...
The "author-at-source" approach is very dynamic, and this approach allows developers to avoid thinking much about localization during development. However, it can also be frustrating for teams that want strict control over the text used in their project. To address this, UE has support for [String Tables](https://dev.epicgames.com/documentation/en-us/unreal-engine/using-string-tables-for-text-in-unreal-engine) to allow an "author-once-and-reference" approach to localization (although internally, the pipeline just treats String Tables as another "author-at-source" source).
...
For more information on optimizing your localization pipeline, see [Pipeline Optimization](https://dev.epicgames.com/documentation/en-us/unreal-engine/pipeline-optimization-for-localization-in-unreal-engine).
