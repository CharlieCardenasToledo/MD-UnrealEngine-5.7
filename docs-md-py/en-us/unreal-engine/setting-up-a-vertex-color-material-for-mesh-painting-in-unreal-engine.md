...
> Source: https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-a-vertex-color-material-for-mesh-painting-in-unreal-engine
...
To learn more about vertex color materials and how you can use them to blend textures layers together for painting on a mesh, see [Setting Up a Texture Blended Material for Mesh Painting](https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-a-texture-blended-material-for-vertex-weights-painting-in-unreal-engine).
